...
clippy.Agent = function (path, data, sounds) {
    ...
    this._el = $('<div class="clippy" data-turbolinks-permanent></div>').hide();

    $("#clippycontainer").append(this._el);
...
clippy.Balloon.prototype = {
    ...
    _setup:function () {
        ...
        $("#clippycontainer").append(this._balloon);
    },
